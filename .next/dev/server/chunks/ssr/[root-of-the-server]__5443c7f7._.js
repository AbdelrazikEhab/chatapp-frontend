...
;
;
const API = ("TURBOPACK compile-time value", "https://chatapp-backend-eosin.vercel.app");
function Register() {
    ...
    const submit = async (e)=>{
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post(API + '/api/auth/register', {
                name,
                email,
                password
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5443c7f7._.js.map